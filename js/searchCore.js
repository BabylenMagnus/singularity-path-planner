...
import { CompoundGrowthProjector, DEFAULT_SINGULARITY_REQUIREMENT, realSecondsFromIntegral } from "./growth.js?v=20260723a";
import { multAfterSingularize, totalMult, weakenedPenaltyExponent } from "./singularize.js?v=20260723a";
import { baseExponent } from "./atomPenalties.js?v=20260723a";
