...
export const TOOLTIPS = {
  ...
  "rank-tree-push":
    "For each Singularity Tree node (1.0, 3.1, 3.2, 6.1, 6.2, 8), pretends you buy +1 FULL ASCENSION (not +1 level -- a level-only bump barely moves the needle at high ascension since the level term gets diluted) and re-times your push targets, plus a flat Mult +10% row as a directly comparable no-tree-change lever. Ranks all of them by time saved. Does not include the cost of buying the upgrade — only how much faster the push becomes afterward.",
  "rush-node":
